...
### Completato ✅
- **Sessione "Layout & Revisione" (4 set 2026)** — 3 commit locali (A layout `e660418`, B revisione `b29090e`, C pronto al push), **NON pushati**: il push su main lo decide Alessio. Nessuna feature nuova.
...
- **4 set 2026**: 3 commit locali (A/B/C) sopra i commit F1–F8: **tutto ancora da pushare**. Al push: Railway fa `prisma db push` (solo aggiunte nullable/nuove tabelle → ok) e riesegue `seed.js` (ora pulito). Nessuna env nuova. Verificare che il servizio Railway sia a 1 replica.
